...
![image](imgs/anslab2a2.jpg)
 การทำงาน 1. ในส่วนแรกเริ่มจาก กำหนด define Window class  และกำหนดค่าต่างๆ 
         2. สร้าง register the window class โดยกำหนดให้=&wc
         3. สร้างหน้าแสดงผล
         โดยกำหนดให้มี ชื่อหน้าแสดงผล กำหนดตำแหน่งต่างๆทั้งแนวตั้งและนอนและ ความสูงและความกว้าง หน้าเมนู 
         4. กำหนด หน้าจอแสดงผล 
         5. สร้างข้อความแบบลูป โดยค่าที่พิมฑิจะเป็นค่าที่กำหนดให้หน้าแจกจะแสดงผลเป็นลายเส้นรูปวงรี โดยบรรทักที่กำหนดนั้นจะเป็นบรรทัด Ellipse และค่าตามหลัง
