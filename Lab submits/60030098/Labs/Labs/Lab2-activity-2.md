...
1. ผลการทำงานของโปรแกรมเป็นอย่างไร ให้ capture หน้าจอพร้อมอธิบายการทำงาน
    ...
    ![Answer1](answeractivity1.PNG)

    จากโค๊ดในส่วนแรกข้อที่ 1 จะเป็นการตั้งค่า Class ใน Windows โดยจะสั่งเชื่อมกับ WndProc ที่ทำการวาดเส้นด้วย

    ข้อที่ 2 เป็นการใส่ Register ใน Windows

    ข้อที่ 3 เป็นการสร้าง Windows

    ข้อที่ 4 เป็นการแสดงผล

    ข้อที่ 5 เป็นการสร้างลูปให้ Windows นี้อยู่ต่อไป
