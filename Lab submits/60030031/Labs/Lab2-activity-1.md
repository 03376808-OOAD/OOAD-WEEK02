...
2. ถ้าไม่ได้ แก้ไขอย่างไร
	ไปที่ project propertise แล้วไปที่ configuration properties ไปที general
	ตั้งค่า character set = use multi-byte character set
	ต่อจากนั้นไปที่ c/c++ และตั้งค่า precompiled header = not using precomplied header
