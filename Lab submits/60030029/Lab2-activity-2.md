...
จะได้โปรแกรมที่มีการวาดรูปวงรีในโปรแกรม
![1.jpg](1.jpg) 
โดยการทำงาน เมื่อวินโดCALLBACK
เมธธอด CALLBACKของโปรแกรมจะทำการรับและเข้า switch (message) จากน้้นจะมีการเรียกขอเพ้นเพื่อนวดรูปวงรีตามโค้ดนี้
case WM_PAINT:
