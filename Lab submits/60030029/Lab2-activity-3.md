...
การทำงานเมื่อเรารันโปรแกรมขึ้นนั้น 
โปรแกรมจะเปิดมาขาวๆไม่มีอะไร (เนื่องจากเราคอมเม้นในส่วนของการวาดวงรีไปแล้ว)
จากนั้นเมื่อเราคลิ๊กขวา-ซ้ายก็จะมีข้อความเด้งขึ้นมา โดยค่าx y จากที่เราคลิ๊กโดยใช้wsprintf ในการเก็บตำแหน่ง 
จากนั้นใช้MessageBox ในการแสดงข้อความ และเมื่อพิมพ์ตัวอังกษ(ในที่ได้1ตัว) ก็จะมีการแสดงตัวอักษรตัวนั้นขึ้นในโปรแกรม
