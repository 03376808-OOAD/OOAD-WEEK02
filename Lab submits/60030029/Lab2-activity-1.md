...
แก้ไขโดย ไปที่ Project ,Property ,Configuration, General , Character Set โดยเปลี่ยนเป็น " Use Multi-Byte-Character Set"
หรือ
Configuration,Header,Precomplod Header โดยปลี่ยนเป็น Not using
