...
![act2.PNG](act2.PNG)
```
เริ่มจากการกำหนดค่าต่าง ๆ ให้ windows class แล้วจึงทำการลงทะเบียน class นั้น จากนั้นจะมีการสร้าง window ขึ้นมาแล้วทำการแสดงผล window นั้น แล้วจึงทำการวนลูปให้แสดงผลข้อมูลที่มาจาก Callback fn ซึ่งในที่นี้ Callback จะทำการวาดวงรีขึ้นมาผ่าน function Ellipse(); และจะไม่มีปัญหาการแสดงผลซ้ำอยู่บนที่เดียวเนื่องจากการวนลูปแสดงผลดังกล่าว
```
